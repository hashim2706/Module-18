...
## OUTPUT
![Screenshot 2025-05-19 131628](https://github.com/user-attachments/assets/fc7afd90-897e-400e-b708-28ace12c85b0)
## RESULT
Thus the Python program to **count the number of triangles** present in an **undirected graph** using matrix operations has been implemented and executed.

...
## OUTPUT
![Screenshot 2025-05-19 132536](https://github.com/user-attachments/assets/06fa895c-caf6-4c5d-8123-7ba512279db2)

## RESULT
Thus the Python program for **Kruskal's algorithm** to find the Minimum Spanning Tree (MST) of a given connected, undirected, and weighted graph has been implemented and executed.
